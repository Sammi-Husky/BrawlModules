Enemy__createInstance_10emDeathpod_:
    /* 0000DD84: */    stwu r1,-0x10(r1)
    /* 0000DD88: */    mflr r0
    /* 0000DD8C: */    stw r0,0x14(r1)
    /* 0000DD90: */    stw r31,0xC(r1)
    /* 0000DD94: */    stw r30,0x8(r1)
    /* 0000DD98: */    mr r30,r3
    /* 0000DD9C: */    mr r31,r4
    /* 0000DDA0: */    li r3,0x5AFC
    /* 0000DDA4: */    li r4,HEAP_TYPE
    /* 0000DDA8: */    bl __unresolved                          [R_PPC_REL24(0, 4, "srHeapType____nw")]
    /* 0000DDAC: */    cmpwi r3,0x0
    /* 0000DDB0: */    beq- loc_DDC0
    /* 0000DDB4: */    mr r4,r30
    /* 0000DDB8: */    mr r5,r31
    /* 0000DDBC: */    bl emDeathpod____ct
loc_DDC0:
    /* 0000DDC0: */    lwz r31,0xC(r1)
    /* 0000DDC4: */    lwz r30,0x8(r1)
    /* 0000DDC8: */    lwz r0,0x14(r1)
    /* 0000DDCC: */    mtlr r0
    /* 0000DDD0: */    addi r1,r1,0x10
    /* 0000DDD4: */    blr

emResourceModuleImpl__ModifyExParam_15emDeathpodParam_:
    /* 0000ECB4: */    lwz r0,0x40(r4)
    /* 0000ECB8: */    cmpwi r0,0x0
    /* 0000ECBC: */    beq- loc_ECC4
    /* 0000ECC0: */    b loc_ECC8
loc_ECC4:
    /* 0000ECC4: */    lwz r0,0x34(r3)
loc_ECC8:
    /* 0000ECC8: */    stw r0,0x2C(r3)
    /* 0000ECCC: */    blr

emResourceModuleImpl__DeleteExParam_15emDeathpodParam_:
    /* 0000F19C: */    blr
...
soArticleMediatorImpl_113soTypeList_78soInstancePoolInfo_12wnemSwHolder_6_22emWeaponInstanceHolde_______dt:
    ...
    /* 0003AC94: */    bl __unresolved              [R_PPC_REL24(27, 1, "soArticleMediator____dt")]
...
loc_3B3AC:
    ...
    /* 0003B3B8: */    lis r3,0x0                               [R_PPC_ADDR16_HA(27, 1, "soArticle__checkActivate")]
    /* 0003B3BC: */    addi r3,r3,0x0                           [R_PPC_ADDR16_LO(27, 1, "soArticle__checkActivate")]
...
loc_3B74C:
    ...
    /* 0003B768: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_C938")]
    /* 0003B76C: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_C938")]
    /* 0003B770: */    li r0,0x1
...
emDeathpodParamAccesser__getParamFloat:
    ...
    /* 0003BA30: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 0003BA34: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 0003BA38: */    li r0,0x1
...
emDeathpodParamAccesser__getParamInt:
    ...
    /* 0003BA84: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 0003BA88: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 0003BA8C: */    li r0,0x1
...
emDeathpodParamAccesser__getParamIndefinite:
    ...
    /* 0003BAF0: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 0003BAF4: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 0003BAF8: */    li r0,0x1
