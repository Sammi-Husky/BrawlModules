Enemy__createInstance_10emRobobeam_:
    /* 0000E5C8: */    stwu r1,-0x10(r1)
    /* 0000E5CC: */    mflr r0
    /* 0000E5D0: */    stw r0,0x14(r1)
    /* 0000E5D4: */    stw r31,0xC(r1)
    /* 0000E5D8: */    stw r30,0x8(r1)
    /* 0000E5DC: */    mr r30,r3
    /* 0000E5E0: */    mr r31,r4
    /* 0000E5E4: */    li r3,0x618C
    /* 0000E5E8: */    li r4,HEAP_TYPE
    /* 0000E5EC: */    bl __unresolved                          [R_PPC_REL24(0, 4, "srHeapType____nw")]
    /* 0000E5F0: */    cmpwi r3,0x0
    /* 0000E5F4: */    beq- loc_E604
    /* 0000E5F8: */    mr r4,r30
    /* 0000E5FC: */    mr r5,r31
    /* 0000E600: */    bl emRobobeam____ct
loc_E604:
    /* 0000E604: */    lwz r31,0xC(r1)
    /* 0000E608: */    lwz r30,0x8(r1)
    /* 0000E60C: */    lwz r0,0x14(r1)
    /* 0000E610: */    mtlr r0
    /* 0000E614: */    addi r1,r1,0x10
    /* 0000E618: */    blr

emResourceModuleImpl__ModifyExParam_15emRobobeamParam_:
    /* 0000EF70: */    lwz r0,0x40(r4)
    /* 0000EF74: */    cmpwi r0,0x0
    /* 0000EF78: */    beq- loc_EF80
    /* 0000EF7C: */    b loc_EF84
loc_EF80:
    /* 0000EF80: */    lwz r0,0x34(r3)
loc_EF84:
    /* 0000EF84: */    stw r0,0x2C(r3)
    /* 0000EF88: */    blr

emResourceModuleImpl__DeleteExParam_15emRobobeamParam_:
    /* 0000F200: */    blr
...
soArticleMediatorImpl_113soTypeList_78soInstancePoolInfo_12wnemSwHolder_5_22emWeaponInstanceHolde_______dt3:
    ...
    /* 000532E8: */    bl __unresolved              [R_PPC_REL24(27, 1, "soArticleMediator____dt")]
...
loc_538F4:
    ...
    /* 00053900: */    lis r3,0x0                               [R_PPC_ADDR16_HA(27, 1, "soArticle__checkActivate")]
    /* 00053904: */    addi r3,r3,0x0                           [R_PPC_ADDR16_LO(27, 1, "soArticle__checkActivate")]
...
loc_53C94:
    ...
    /* 00053CB0: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_C938")]
    /* 00053CB4: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_C938")]
    /* 00053CB8: */    li r0,0x1
...
emRobobeamParamAccesser__getParamFloat:
    ...
    /* 00053F68: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 00053F6C: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 00053F70: */    li r0,0x1
...
emRobobeamParamAccesser__getParamInt:
    ...
    /* 00053FBC: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 00053FC0: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 00053FC4: */    li r0,0x1
...
emRobobeamParamAccesser__getParamIndefinite:
    ...
    /* 0005403C: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 00054040: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 00054044: */    li r0,0x1
