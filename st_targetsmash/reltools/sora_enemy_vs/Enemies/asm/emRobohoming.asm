Enemy__createInstance_12emRobohoming_:
    /* 0000E670: */    stwu r1,-0x10(r1)
    /* 0000E674: */    mflr r0
    /* 0000E678: */    stw r0,0x14(r1)
    /* 0000E67C: */    stw r31,0xC(r1)
    /* 0000E680: */    stw r30,0x8(r1)
    /* 0000E684: */    mr r30,r3
    /* 0000E688: */    mr r31,r4
    ...
    /* 0000E6A0: */    mr r4,r30
    /* 0000E6A4: */    mr r5,r31
    /* 0000E6A8: */    bl emRobohoming____ct
loc_E6AC:
    /* 0000E6AC: */    lwz r31,0xC(r1)
    /* 0000E6B0: */    lwz r30,0x8(r1)
    /* 0000E6B4: */    lwz r0,0x14(r1)
    /* 0000E6B8: */    mtlr r0
    /* 0000E6BC: */    addi r1,r1,0x10
    /* 0000E6C0: */    blr

emResourceModuleImpl__ModifyExParam_17emRobohomingParam_:
    /* 0000EFA8: */    lwz r0,0x40(r4)
    /* 0000EFAC: */    cmpwi r0,0x0
    /* 0000EFB0: */    beq- loc_EFB8
    /* 0000EFB4: */    b loc_EFBC
loc_EFB8:
    /* 0000EFB8: */    lwz r0,0x34(r3)
loc_EFBC:
    /* 0000EFBC: */    stw r0,0x2C(r3)
    /* 0000EFC0: */    blr

emResourceModuleImpl__DeleteExParam_17emRobohomingParam_:
    /* 0000F208: */    blr
...
soArticleMediatorImpl_113soTypeList_78soInstancePoolInfo_12wnemSwHolder_5_22emWeaponInstanceHolde_______dt4:
    ...
    /* 000558C4: */    bl __unresolved              [R_PPC_REL24(27, 1, "soArticleMediator____dt")]
...
loc_55FA4:
    ...
    /* 00055FB0: */    lis r3,0x0                               [R_PPC_ADDR16_HA(27, 1, "soArticle__checkActivate")]
    /* 00055FB4: */    addi r3,r3,0x0                           [R_PPC_ADDR16_LO(27, 1, "soArticle__checkActivate")]
...
loc_56344:
    ...
    /* 00056360: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_C938")]
    /* 00056364: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_C938")]
    /* 00056368: */    li r0,0x1
...
emRobohomingParamAccesser__getParamFloat:
    ...
    /* 00056618: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 0005661C: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 00056620: */    li r0,0x1
...
emRobohomingParamAccesser__getParamInt:
    ...
    /* 00056664: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 00056668: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 0005666C: */    li r0,0x1
...
emRobohomingParamAccesser__getParamIndefinite:
    ...
    /* 000566B4: */    lis r6,0x0                               [R_PPC_ADDR16_HA(27, 5, "loc_80F0")]
    /* 000566B8: */    addi r6,r6,0x0                           [R_PPC_ADDR16_LO(27, 5, "loc_80F0")]
    /* 000566BC: */    li r0,0x1
